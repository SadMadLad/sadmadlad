import{r,a as S,L as z,u as W,B as G,b as N,c as h,R}from"./react-6dba30b1.js";import{S as w,_ as Z}from"./syntax-cf0f1825.js";import{m as c,A as g,u as E,a as T,b as F,R as Y,r as L,c as A}from"./fancy-5dcc333e.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))i(a);new MutationObserver(a=>{for(const o of a)if(o.type==="childList")for(const l of o.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&i(l)}).observe(document,{childList:!0,subtree:!0});function n(a){const o={};return a.integrity&&(o.integrity=a.integrity),a.referrerPolicy&&(o.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?o.credentials="include":a.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(a){if(a.ep)return;a.ep=!0;const o=n(a);fetch(a.href,o)}})();var I={exports:{}},f={};/**
 * @license React
 ...
 */var H=r,M=Symbol.for("react.element"),J=Symbol.for("react.fragment"),V=Object.prototype.hasOwnProperty,X=H.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,P={key:!0,ref:!0,__self:!0,__source:!0};function C(s,t,n){var i,a={},o=null,l=null;n!==void 0&&(o=""+n),t.key!==void 0&&(o=""+t.key),t.ref!==void 0&&(l=t.ref);for(i in t)V.call(t,i)&&!P.hasOwnProperty(i)&&(a[i]=t[i]);if(s&&s.defaultProps)for(i in t=s.defaultProps,t)a[i]===void 0&&(a[i]=t[i]);return{$$typeof:M,type:s,key:o,ref:l,props:a,_owner:X.current}}f.Fragment=J;f.jsx=C;f.jsxs=C;I.exports=f;var e=I.exports,y={},k=S;y.createRoot=k.createRoot,y.hydrateRoot=k.hydrateRoot;function O(){const s=[{route:"/projects",name:"Projects"},{route:"/diary",name:"Diary"},{route:"/notes",name:"Notes"},{route:"/command-lines",name:"Command Lines"},{route:"/blogs",name:"Blogs"}];return e.jsxs("main",{className:"my-20 flex flex-col gap-10 items-center px-8",children:[e.jsx("h6",{className:"text-2xl font-black",children:"Hi! I am Saad"}),e.jsx("p",{className:"text-2xl sm:text-4xl font-extralight text-center w-full md:w-2/3",children:"I am a Software Developer with love for Machine Learning and Data Science."}),e.jsx("div",{className:"flex flex-row flex-wrap justify-center gap-2",children:s.map(t=>e.jsx(z,{to:t.route,className:"shadow-xl border border-opacity-25 border-lite font-serif bg-darklite text-2xl px-6 py-4 hover:bg-lite hover:text-darklite duration-300 transition-colors",children:t.name},t.route))})]})}const U="/sadmadlad/technologies/JavaScript.png",K="/sadmadlad/technologies/Python.png",D="/sadmadlad/technologies/Html.png",q="/sadmadlad/technologies/Cpp.png",Q="/sadmadlad/technologies/Ruby.png",$="/sadmadlad/technologies/Css.png";function ee(){return e.jsxs("section",{className:"px-8 bg-darklite min-w-full py-14 flex gap-10 lg:justify-center overflow-x-auto no-scrollbar",children:[e.jsx("img",{src:U}),e.jsx("img",{src:K}),e.jsx("img",{src:q}),e.jsx("img",{src:Q}),e.jsx("img",{src:D}),e.jsx("img",{src:$})]})}function te({heading:s,leadingIcon:t,description:n,techStacks:i}){return e.jsxs("li",{className:"bg-darklite border-b-4 border-b-black border-opacity-40 p-8 flex flex-col gap-8 justify-between",children:[e.jsxs("div",{className:"flex flex-col items-center gap-6 w-48",children:[e.jsx("h5",{className:"text-4xl font-serif",children:s}),e.jsx("img",{src:t}),e.jsx("p",{className:"text-center",children:n})]}),e.jsx("ul",{className:"flex justify-center gap-3",children:i.map(a=>e.jsx("img",{src:a},a))})]})}const se="/sadmadlad/technologies/Frontend.png",ae="/sadmadlad/technologies/Backend.png",ne="/sadmadlad/technologies/ML.png",oe="/sadmadlad/technologies/Miscellaneous.png",ie="/sadmadlad/technologies/React.png",le="/sadmadlad/technologies/Vite.png",re="/sadmadlad/technologies/Tailwind.png",ce="/sadmadlad/technologies/Hotwired.png",de="/sadmadlad/technologies/NodeJS.png",he="/sadmadlad/technologies/PostgreSQL.png",pe="/sadmadlad/technologies/MongoDB.png",ue="/sadmadlad/technologies/RubyOnRails.png",me="/sadmadlad/technologies/TensorFlow.png",ge="/sadmadlad/technologies/PyTorch.png",fe="/sadmadlad/technologies/Pandas.png",be="/sadmadlad/technologies/Figma.png",xe="/sadmadlad/technologies/Rust.png",ye="/sadmadlad/technologies/Unity.png",we="/sadmadlad/technologies/BeautifulSoup4.png";function ve(){const s=[{heading:"Frontend",leadingIcon:se,description:"Experienced with many frontend technologies, ranging from CSS frameworks to JavaScript ones.",techStacks:[ie,le,re,ce]},{heading:"Backend",leadingIcon:ae,description:"Have worked with different databases with different backend frameworks.",techStacks:[de,he,pe,ue]},{heading:"ML",leadingIcon:ne,description:"Delved in the areas of machine learning and worked with related frameworks. Created NNs, Classifiers, GANs, Autoencoders etc.",techStacks:[me,ge,fe]},{heading:"Miscellaneous",leadingIcon:oe,description:"Web Scraping as a hobby. Always enjoy and eager to learn new frameworks and programming languages.",techStacks:[be,xe,ye,we]}];return e.jsxs(e.Fragment,{children:[e.jsx("h6",{className:"mt-20 text-2xl font-black text-center w-full md:w-2/3 px-4",children:"Versatile skill set in different domains, and always interested in expanding it even more."}),e.jsx("section",{className:"px-8 mb-20 mt-16 w-full flex justify-start lg:justify-center gap-8 overflow-x-auto no-scrollbar",children:s.map(({heading:t,leadingIcon:n,description:i,techStacks:a})=>e.jsx(te,{heading:t,leadingIcon:n,description:i,techStacks:a},t))})]})}function b(){return e.jsxs("header",{className:"mt-4 sm:mt-10 w-full lg:w-3/4 flex justify-between font-serif items-end border-b border-b-lite pb-3 sm:pb-6 px-3",children:[e.jsx("h1",{className:"text-xl sm:text-2xl lg:text-4xl",children:"Muhammad Saad Azam"}),e.jsxs("nav",{className:"hidden sm:flex gap-6 lg:gap-10 text-xl lg:text-2xl",children:[e.jsx("a",{href:"https://www.linkedin.com/in/saad-azam-9113011b8/",children:"LinkedIn"}),e.jsx("a",{href:"https://github.com/SadMadLad",children:"GitHub"}),e.jsx("a",{href:"https://www.kaggle.com/sadmadlad",children:"Kaggle"})]})]})}function _e(){return e.jsxs("div",{className:"flex flex-col items-center",children:[e.jsx(b,{}),e.jsx(O,{}),e.jsx(ee,{}),e.jsx(ve,{})]})}const B={"hljs-comment":{color:"#B6B18B"},"hljs-quote":{color:"#B6B18B"},"hljs-variable":{color:"#EB3C54"},"hljs-template-variable":{color:"#EB3C54"},"hljs-tag":{color:"#EB3C54"},"hljs-name":{color:"#EB3C54"},"hljs-selector-id":{color:"#EB3C54"},"hljs-selector-class":{color:"#EB3C54"},"hljs-regexp":{color:"#EB3C54"},"hljs-deletion":{color:"#EB3C54"},"hljs-number":{color:"#E7CE56"},"hljs-built_in":{color:"#E7CE56"},"hljs-builtin-name":{color:"#E7CE56"},"hljs-literal":{color:"#E7CE56"},"hljs-type":{color:"#E7CE56"},"hljs-params":{color:"#E7CE56"},"hljs-meta":{color:"#E7CE56"},"hljs-link":{color:"#E7CE56"},"hljs-attribute":{color:"#EE7C2B"},"hljs-string":{color:"#4FB4D7"},"hljs-symbol":{color:"#4FB4D7"},"hljs-bullet":{color:"#4FB4D7"},"hljs-addition":{color:"#4FB4D7"},"hljs-title":{color:"#78BB65"},"hljs-section":{color:"#78BB65"},"hljs-keyword":{color:"#B45EA4"},"hljs-selector-tag":{color:"#B45EA4"},hljs:{display:"block",overflowX:"auto",background:"#1C1D21",color:"#c0c5ce",padding:"0.5em"},"hljs-emphasis":{fontStyle:"italic"},"hljs-strong":{fontWeight:"bold"}},je={hljs:{display:"block",overflowX:"auto",padding:"0.5em",color:"#abb2bf",background:"#282c34"},"hljs-keyword":{color:"#F92672"},"hljs-operator":{color:"#F92672"},"hljs-pattern-match":{color:"#F92672"},"hljs-pattern-match .hljs-constructor":{color:"#61aeee"},"hljs-function":{color:"#61aeee"},"hljs-function .hljs-params":{color:"#A6E22E"},"hljs-function .hljs-params .hljs-typing":{color:"#FD971F"},"hljs-module-access .hljs-module":{color:"#7e57c2"},"hljs-constructor":{color:"#e2b93d"},"hljs-constructor .hljs-string":{color:"#9CCC65"},"hljs-comment":{color:"#b18eb1",fontStyle:"italic"},"hljs-quote":{color:"#b18eb1",fontStyle:"italic"},"hljs-doctag":{color:"#c678dd"},"hljs-formula":{color:"#c678dd"},"hljs-section":{color:"#e06c75"},"hljs-name":{color:"#e06c75"},"hljs-selector-tag":{color:"#e06c75"},"hljs-deletion":{color:"#e06c75"},"hljs-subst":{color:"#e06c75"},"hljs-literal":{color:"#56b6c2"},"hljs-string":{color:"#98c379"},"hljs-regexp":{color:"#98c379"},"hljs-addition":{color:"#98c379"},"hljs-attribute":{color:"#98c379"},"hljs-meta-string":{color:"#98c379"},"hljs-built_in":{color:"#e6c07b"},"hljs-class .hljs-title":{color:"#e6c07b"},"hljs-attr":{color:"#d19a66"},"hljs-variable":{color:"#d19a66"},"hljs-template-variable":{color:"#d19a66"},"hljs-type":{color:"#d19a66"},"hljs-selector-class":{color:"#d19a66"},"hljs-selector-attr":{color:"#d19a66"},"hljs-selector-pseudo":{color:"#d19a66"},"hljs-number":{color:"#d19a66"},"hljs-symbol":{color:"#61aeee"},"hljs-bullet":{color:"#61aeee"},"hljs-link":{color:"#61aeee",textDecoration:"underline"},"hljs-meta":{color:"#61aeee"},"hljs-selector-id":{color:"#61aeee"},"hljs-title":{color:"#61aeee"},"hljs-emphasis":{fontStyle:"italic"},"hljs-strong":{fontWeight:"bold"}};function ke({codeSnippet:s}){return e.jsx("div",{className:"my-2.5",children:e.jsx(w,{wrapLines:!0,style:B,language:s.language,children:s.code})})}function u({paragraph:s}){const{has_code_snippet:t,text:n,code_snippet:i}=s;return e.jsxs("div",{children:[e.jsx("p",{dangerouslySetInnerHTML:{__html:n}}),t&&e.jsx(ke,{codeSnippet:i})]})}function Ie({solution:s}){const{has_intro:t,has_outro:n,steps:i}=s;return e.jsxs("div",{children:[t&&e.jsx(u,{paragraph:s.intro}),e.jsx("ul",{className:"list-decimal m-2",children:i.map((a,o)=>e.jsx("li",{children:e.jsx(u,{paragraph:a})},o))}),n&&e.jsx(u,{paragraph:s.outro})]})}function Ce({title:s,titleId:t,...n},i){return r.createElement("svg",Object.assign({xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 20 20",fill:"currentColor","aria-hidden":"true",ref:i,"aria-labelledby":t},n),s?r.createElement("title",{id:t},s):null,r.createElement("path",{fillRule:"evenodd",d:"M5.23 7.21a.75.75 0 011.06.02L10 11.168l3.71-3.938a.75.75 0 111.08 1.04l-4.25 4.5a.75.75 0 01-1.08 0l-4.25-4.5a.75.75 0 01.02-1.06z",clipRule:"evenodd"}))}const Be=r.forwardRef(Ce),x=Be;function Se({title:s,type:t,updatedOn:n,description:i,solution:a}){const[o,l]=r.useState(!1),d=p=>{const m={Bug:"bg-red-600",Feature:"bg-green-600","Small Issue":"bg-yellow-600"};return e.jsx("button",{className:`${m[p]} px-1.5 py-0.5 rounded font-semibold`,children:p})};return e.jsxs(c.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},className:"px-2",children:[e.jsxs("div",{className:"flex flex-row gap-2 items-center border-b border-b-lite",children:[e.jsx("h5",{className:"font-bold text-lg",children:s}),e.jsx(c.div,{animate:{rotate:o?180:0,cursor:"pointer"},onClick:()=>l(!o),children:e.jsx(x,{className:"w-6 h-6"})})]}),e.jsx(g,{children:o&&e.jsxs(c.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},className:"flex flex-col gap-2.5 py-2",children:[e.jsxs("div",{className:"flex flex-col gap-0.5",children:[e.jsx("span",{children:d(t)}),e.jsxs("span",{children:[e.jsx("b",{children:"Updated On: "}),e.jsx("span",{children:n})]})]}),e.jsxs("div",{children:[e.jsx("h6",{className:"font-semibold",children:"Description:"}),e.jsx("p",{dangerouslySetInnerHTML:{__html:i}})]}),e.jsxs("div",{children:[e.jsx("h6",{className:"font-semibold",children:"Solution: "}),a.has_steps?e.jsx(Ie,{solution:a}):e.jsx(u,{paragraph:a})]})]})})]})}function ze({title:s,entries:t}){const n=t.sort((o,l)=>o.title>l.title),[i,a]=r.useState(!1);return e.jsxs("section",{className:"mt-2.5 px-2 md:px-0",children:[e.jsxs("div",{className:"flex flex-row gap-2 items-center border-b-2 border-b-lite",children:[e.jsx("h4",{className:"font-serif font-bold text-2xl",children:s}),e.jsx(c.div,{animate:{rotate:i?180:0,cursor:"pointer"},onClick:()=>a(!i),children:e.jsx(x,{className:"w-8 h-8"})})]}),e.jsx(g,{children:i&&n.map((o,l)=>e.jsx(Se,{title:o.title,type:o.type,updatedOn:o.updated_on,description:o.description,solution:o.solution},l))})]})}const We=[{title:"Ruby on Rails",entries:[{title:"Complex Validation for Password in Devise",type:"Bug",updated_on:"28th June, 2023",description:'I had to apply complex validation (like presence of a special character and a number) for password. I initially did it like this <code class="bg-zinc-800">validates :password, ..validations</code>. And on the app, I also had to update other info (like name) for the user. With this implementation, the password was coming out to be <code class="bg-zinc-800">nil</code>. At first, I thought that updating user required password, but that was not the case.',solution:{has_steps:!1,has_code_snippet:!0,text:`In a typical devise model (which in my case was <code class="bg-zinc-800">User</code>), there is no field/attribute named password. Instead, the encrypted password is stored in the database. So, how does Devise takes the input password? Actually, it stores the input password temporarily as <b>instance variable</b>, and I was unable to apply validations on the password field because on update, there was no instance variable of password being passed. This snippet basically checks if the instance of password variable is present, and allows it to be blank if the user is being updated. Otherwise, it checks for the specified regex expression. When it comes to creating new user, the presence of password can be checked by the length which is specified in devise's initializer file. The keypoint is understanding how devise manages passwords.`,code_snippet:{language:"ruby",code:`validate :password_regex
...
`}}}]}];function v({title:s,heroCaption:t}){return e.jsxs("section",{className:"flex flex-col gap-4 items-center my-20",children:[e.jsx("h1",{className:"font-black font-serif text-4xl",children:s}),e.jsx("p",{className:"text-xl text-center font-light w-full md:w-2/3",children:t})]})}function Ge(){const s=We.sort((t,n)=>t.title>n.title);return e.jsxs("div",{className:"flex flex-col items-center pb-6",children:[e.jsx(b,{}),e.jsx(v,{title:"Diary",heroCaption:"This diary includes some errors and bugs I encountered and how I fixed them, along with some code snippets."}),e.jsx("div",{className:"w-full md:w-3/4",children:s.map((t,n)=>e.jsx(ze,{title:t.title,entries:t.entries},n))})]})}const Ne=[{command:"cat <path/to/filename>",description:"Open file in terminal."},{command:"sudo fuser -k <port>/<protocol>",description:'Kill a web process running on the specific port. Where port is the <code class="bg-zinc-800">port</code> on which the process is running, and the <code class="bg-zinc-800">protocol</code> is mostly <code class="bg-zinc-800">tcp</code> or <code class="bg-zinc-800">udp</code>.'},{command:"cargo new <project-name> --vcs=git",description:"Creates a new rust project with the given name. The --vcs flag allows to use Version Control System optionally."},{command:"chmod +x <file-name>",description:'<code class="bg-zinc-800">chmod</code> is short for Change Mode. It allows us to change the access of file permissions and directiories. The <code class="bg-zinc-800">+x</code> flag allows that file to be executable.'},{command:"man <command-name>",description:"Displays a manual related to the command in terminal."},{command:"script <file-name>",description:'Starts a script in terminal. Now whatever is written on the terminal, will be saved in the <code class="bg-zinc-800">file-name</code> after the <code class="bg-zinc-800">exit</code> command.'},{command:"mix new <project-name>",description:"Initializes a new mix project with the given project name."},{command:"mix deps.get",description:"Gets all out of date dependencies, i.e. dependencies that are not available or have an invalid lock."},{command:"mix compile",description:"The main entry point for the project. It runs the compilers in the project and returns a tuple with the compilation status and a list of diagnostics. Before compiling the code, it runs all the dependencies and performs a series of checks."},{command:"cargo build",description:'Builds the project, creates an executable file under <code class="bg-zinc-800">./target/debug/project-name</code>. Also, creates a <code span="bg-zinc-800">Cargo.toml</code> file to keep track of dependencies.'},{command:"cargo run",description:"Builds and executes the code in one go."},{command:"cargo check",description:"Does not execute the code but makes sure that the code compiles."},{command:"cargo build --release",description:"Compiles and optimizes the code and prepares to release the product."}];function Re(){const s=Ne.sort((t,n)=>t.command>n.command);return e.jsx("main",{className:"px-5",children:e.jsx("ul",{className:"list-disc flex flex-col gap-4",children:s.map((t,n)=>e.jsxs("li",{children:[e.jsx(w,{wrapLines:!0,style:je,language:"vim",children:t.command}),e.jsx("p",{className:"mt-1",dangerouslySetInnerHTML:{__html:t.description}})]},n))})})}function Ze(){return e.jsxs("div",{className:"flex flex-col items-center pb-6",children:[e.jsx(b,{}),e.jsx(v,{title:"Command Lines",heroCaption:"Some useful command lines that I learnt on the way"}),e.jsx("div",{className:"w-full md:w-3/4",children:e.jsx(Re,{})})]})}function Ee({title:s,paragraphs:t}){const[n,i]=r.useState(!1);return e.jsxs(c.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},className:"px-2",children:[e.jsxs("div",{className:"flex flex-row gap-2 items-center border-b border-b-lite",children:[e.jsx("h5",{className:"font-bold text-lg",children:s}),e.jsx(c.div,{animate:{rotate:n?180:0,cursor:"pointer"},onClick:()=>i(!n),children:e.jsx(x,{className:"w-6 h-6"})})]}),e.jsx(g,{children:n&&e.jsx(c.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},className:"flex flex-col gap-2.5 py-2",children:t.map((a,o)=>e.jsx(u,{paragraph:a},o))})})]})}function Te({title:s,notes:t}){const n=t.sort((o,l)=>o.title>l.title),[i,a]=r.useState(!1);return e.jsxs("section",{className:"px-2 md:px-0",children:[e.jsxs("div",{className:"flex flex-row gap-2 items-center border-b-2 border-b-lite",children:[e.jsx("h4",{className:"font-serif font-bold text-2xl",children:s}),e.jsx(c.div,{animate:{rotate:i?180:0,cursor:"pointer"},onClick:()=>a(!i),children:e.jsx(x,{className:"w-8 h-8"})})]}),e.jsx(g,{children:i&&n.map((o,l)=>e.jsx(Ee,{title:o.title,paragraphs:o.paragraphs},l))})]})}const Fe=[{title:"C++",notes:[{title:"Preprocessors",paragraphs:[{text:"Preprocessors in a C++ file are basically commands or files executed before the file does. They start with a #.",has_code_snippet:!1}]},{title:"Header Guards",paragraphs:[{text:"Header Guards ensure us to include our file only once in our file and avoid redeclaration.",has_code_snippet:!1},{text:`There are two ways to define header guards. One is by using <code class="bg-zinc-800"><b>#pragma once</b></code> and the other is <code class="bg-zinc-800"><b>#ifndef, #define, #endif</b></code>. Both of these do the same thing and make sure to include the file only once.
...
`,has_code_snippet:!1}]}]}];function Ye(){const s=Fe.sort((t,n)=>t.title>n.title);return e.jsxs("div",{className:"flex flex-col items-center pb-6",children:[e.jsx(b,{}),e.jsx(v,{title:"Notes",heroCaption:"This page has some notes, tips and some resources that I learnt about on my way."}),e.jsx("div",{className:"w-full md:w-3/4 flex flex-col gap-2.5",children:s.map((t,n)=>e.jsx(Te,{title:t.title,notes:t.notes},n))})]})}function Le(){return e.jsx("div",{children:"Coming Soon."})}function Ae(){return e.jsx("article",{children:"Coming soon."})}const He=[{identifier:"hello-world",tags:["JavaScript","Ruby","Markdown"],category:"Other",date:"3rd August, 2023"}],Me=s=>He.find(({identifier:t})=>t==s),Je="data:text/markdown;base64,";function Ve(){const{scrollYProgress:s}=E(),t=T(s,{stiffness:100,damping:30,restDelta:.001});F();const{identifier:n}=W(),[i,a]=r.useState("");return Me(n)===void 0?e.jsx("div",{children:"Not Found"}):(Z(()=>import(Je),[]).then(l=>{fetch(l.default).then(d=>d.text()).then(d=>a(d))}),e.jsxs("article",{className:"markdown",children:[e.jsx(Y,{rehypePlugins:[L],remarkPlugins:[A],children:i,components:{code({node:l,inline:d,className:p,children:m,..._}){const j=/language-(\w+)/.exec(p||"");return!d&&j?e.jsx(w,{..._,children:String(m).replace(/\n$/,""),style:B,language:j[1]}):e.jsx("code",{..._,className:p,children:m})}}}),e.jsx(c.div,{className:"bg-accent h-2 w-full fixed bottom-20 text-center",style:{scaleX:t}})]}))}function Xe(){return e.jsx(G,{basename:"/sadmadlad",children:e.jsxs(N,{children:[e.jsx(h,{path:"/",element:e.jsx(_e,{})}),e.jsx(h,{exact:!0,path:"/diary",element:e.jsx(Ge,{})}),e.jsx(h,{exact:!0,path:"/command-lines",element:e.jsx(Ze,{})}),e.jsx(h,{exact:!0,path:"/notes",element:e.jsx(Ye,{})}),e.jsx(h,{exact:!0,path:"/projects",element:e.jsx(Le,{})}),e.jsx(h,{exact:!0,path:"/blogs",element:e.jsx(Ae,{})}),e.jsx(h,{path:"/blog/:identifier",element:e.jsx(Ve,{})})]})})}y.createRoot(document.getElementById("root")).render(e.jsx(R.StrictMode,{children:e.jsx(Xe,{})}));
