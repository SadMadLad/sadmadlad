import{r as l,a as R,L as C,u as B,b as P,c as L,d as h,B as A,R as O}from"./react-e182c055.js";import{u as M,m as c,A as m,a as F,b as D,R as U,r as H,c as $}from"./fancy-b3ef572f.js";import{S as j,_ as q}from"./syntax-930cf2fd.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const o of n)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function a(n){const o={};return n.integrity&&(o.integrity=n.integrity),n.referrerPolicy&&(o.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?o.credentials="include":n.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(n){if(n.ep)return;n.ep=!0;const o=a(n);fetch(n.href,o)}})();var I={exports:{}},f={};/**
 * @license React
...
`}}}]}];function k({title:s,heroCaption:t}){return e.jsxs("section",{className:"flex flex-col gap-4 items-center my-20",children:[e.jsx("h1",{className:"font-black font-serif text-4xl",children:s}),e.jsx("p",{className:"text-xl text-center font-light w-full md:w-2/3",children:t})]})}function Le(){const s=Pe.sort((t,a)=>t.title>a.title);return e.jsxs("div",{className:"flex flex-col items-center pb-6",children:[e.jsx(b,{}),e.jsx(k,{title:"Diary",heroCaption:"This diary includes some errors and bugs I encountered and how I fixed them, along with some code snippets."}),e.jsx("div",{className:"w-full md:w-3/4",children:s.map((t,a)=>e.jsx(Be,{title:t.title,entries:t.entries},a))}),e.jsx(x,{})]})}const Ae=[{command:"cat <path/to/filename>",description:"Open file in terminal."},{command:"sudo fuser -k <port>/<protocol>",description:'Kill a web process running on the specific port. Where port is the <code class="bg-zinc-800">port</code> on which the process is running, and the <code class="bg-zinc-800">protocol</code> is mostly <code class="bg-zinc-800">tcp</code> or <code class="bg-zinc-800">udp</code>.'},{command:"cargo new <project-name> --vcs=git",description:"Creates a new rust project with the given name. The --vcs flag allows to use Version Control System optionally."},{command:"chmod +x <file-name>",description:'<code class="bg-zinc-800">chmod</code> is short for Change Mode. It allows us to change the access of file permissions and directiories. The <code class="bg-zinc-800">+x</code> flag allows that file to be executable.'},{command:"man <command-name>",description:"Displays a manual related to the command in terminal."},{command:"script <file-name>",description:'Starts a script in terminal. Now whatever is written on the terminal, will be saved in the <code class="bg-zinc-800">file-name</code> after the <code class="bg-zinc-800">exit</code> command.'},{command:"mix new <project-name>",description:"Initializes a new mix project with the given project name."},{command:"mix deps.get",description:"Gets all out of date dependencies, i.e. dependencies that are not available or have an invalid lock."},{command:"mix compile",description:"The main entry point for the project. It runs the compilers in the project and returns a tuple with the compilation status and a list of diagnostics. Before compiling the code, it runs all the dependencies and performs a series of checks."},{command:"cargo build",description:'Builds the project, creates an executable file under <code class="bg-zinc-800">./target/debug/project-name</code>. Also, creates a <code span="bg-zinc-800">Cargo.toml</code> file to keep track of dependencies.'},{command:"cargo run",description:"Builds and executes the code in one go."},{command:"cargo check",description:"Does not execute the code but makes sure that the code compiles."},{command:"cargo build --release",description:"Compiles and optimizes the code and prepares to release the product."}];function Oe(){const s=Ae.sort((t,a)=>t.command>a.command);return e.jsx("main",{className:"px-5",children:e.jsx("ul",{className:"list-disc flex flex-col gap-4",children:s.map((t,a)=>e.jsxs("li",{children:[e.jsx(j,{wrapLines:!0,style:Te,language:"vim",children:t.command}),e.jsx("p",{className:"mt-1",dangerouslySetInnerHTML:{__html:t.description}})]},a))})})}function Me(){return e.jsxs("div",{className:"flex flex-col items-center pb-6",children:[e.jsx(b,{}),e.jsx(k,{title:"Command Lines",heroCaption:"Some useful command lines that I learnt on the way"}),e.jsx("div",{className:"w-full md:w-3/4",children:e.jsx(Oe,{})}),e.jsx(x,{})]})}function Fe({title:s,paragraphs:t}){const[a,i]=l.useState(!1);return e.jsxs(c.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},className:"px-2",children:[e.jsxs("div",{className:"flex flex-row gap-2 items-center border-b border-b-lite",children:[e.jsx("h5",{className:"font-bold text-lg",children:s}),e.jsx(c.div,{animate:{rotate:a?180:0,cursor:"pointer"},onClick:()=>i(!a),children:e.jsx(w,{className:"w-6 h-6"})})]}),e.jsx(m,{children:a&&e.jsx(c.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},className:"flex flex-col gap-2.5 py-2",children:t.map((n,o)=>e.jsx(u,{paragraph:n},o))})})]})}function De({title:s,notes:t}){const a=t.sort((o,r)=>o.title>r.title),[i,n]=l.useState(!1);return e.jsxs("section",{className:"px-2 md:px-0",children:[e.jsxs("div",{className:"flex flex-row gap-2 items-center border-b-2 border-b-lite",children:[e.jsx("h4",{className:"font-serif font-bold text-2xl",children:s}),e.jsx(c.div,{animate:{rotate:i?180:0,cursor:"pointer"},onClick:()=>n(!i),children:e.jsx(w,{className:"w-8 h-8"})})]}),e.jsx(m,{children:i&&a.map((o,r)=>e.jsx(Fe,{title:o.title,paragraphs:o.paragraphs},r))})]})}const Ue=[{title:"C++",notes:[{title:"Preprocessors",paragraphs:[{text:"Preprocessors in a C++ file are basically commands or files executed before the file does. They start with a #.",has_code_snippet:!1}]},{title:"Header Guards",paragraphs:[{text:"Header Guards ensure us to include our file only once in our file and avoid redeclaration.",has_code_snippet:!1},{text:`There are two ways to define header guards. One is by using <code class="bg-zinc-800"><b>#pragma once</b></code> and the other is <code class="bg-zinc-800"><b>#ifndef, #define, #endif</b></code>. Both of these do the same thing and make sure to include the file only once.
...
`,has_code_snippet:!1}]}]}];function He(){const s=Ue.sort((t,a)=>t.title>a.title);return e.jsxs("div",{className:"flex flex-col items-center pb-6",children:[e.jsx(b,{}),e.jsx(k,{title:"Notes",heroCaption:"This page has some notes, tips and some resources that I learnt about on my way."}),e.jsx("div",{className:"w-full md:w-3/4 flex flex-col gap-2.5",children:s.map((t,a)=>e.jsx(De,{title:t.title,notes:t.notes},a))}),e.jsx(x,{})]})}function $e(){return e.jsx("div",{children:"Coming Soon."})}const v=[{identifier:"os-william-stallings",tags:["Operating Systems","Book Review","Computer Science"],categories:["Operating Systems","Book Reviews"],title:"Book Review: Operating Systems by William Stallings",date:"23rd June, 2023.",cover:!1}];function qe(){return console.log(v),e.jsx("ul",{children:v.map(({identifier:s,date:t,title:a})=>e.jsx("li",{children:e.jsxs(C,{to:`/blog/${s}`,children:[a,", ",t]})},s))})}const We=async s=>v.find(({identifier:t})=>t===s),Ve=async s=>{const t=`/sadmadlad/src/assets/blogs/${s}.md`,a=await q(()=>import(t),[]);return await(await fetch(a.default)).text()},Je=async s=>await We(s)===void 0?{blogFound:!1,blog:void 0}:{blogFound:!0,blog:await Ve(s)};function Ge(){const{scrollYProgress:s}=F(),t=D(s,{stiffness:100,damping:30,restDelta:.001}),{identifier:a}=B(),[i,n]=l.useState(!1),[o,r]=l.useState("");return l.useEffect(()=>{(async p=>{const{blogFound:d,blog:g}=await Je(p);d&&r(g),n(d)})(a)},[a]),e.jsx(e.Fragment,{children:i?e.jsxs("article",{className:"markdown",children:[e.jsx(U,{rehypePlugins:[H],remarkPlugins:[$],children:o,components:{code({node:y,inline:p,className:d,children:g,...z}){const S=/language-(\w+)/.exec(d||"");return!p&&S?e.jsx(j,{...z,children:String(g).replace(/\n$/,""),style:E,language:S[1]}):e.jsx("code",{...z,className:d,children:g})}}}),e.jsx(c.div,{className:"bg-accent h-2 w-full fixed bottom-20 text-center",style:{scaleX:t}})]}):e.jsx("div",{children:"Not Found"})})}function Xe(){const s=P();return e.jsx(m,{mode:"wait",initial:!1,children:e.jsxs(L,{location:s,children:[e.jsx(h,{path:"/",element:e.jsx(Se,{})}),e.jsx(h,{path:"/diary",element:e.jsx(Le,{})}),e.jsx(h,{path:"/command-lines",element:e.jsx(Me,{})}),e.jsx(h,{path:"/notes",element:e.jsx(He,{})}),e.jsx(h,{path:"/projects",element:e.jsx($e,{})}),e.jsx(h,{path:"/blogs",element:e.jsx(qe,{})}),e.jsx(h,{path:"/blog/:identifier",element:e.jsx(Ge,{})})]},s.pathname)})}function Ye(){return e.jsx(A,{basename:"/sadmadlad",children:e.jsx(Xe,{})})}_.createRoot(document.getElementById("root")).render(e.jsx(O.StrictMode,{children:e.jsx(Ye,{})}));
