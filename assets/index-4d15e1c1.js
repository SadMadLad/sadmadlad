import{r,a as C,L as B,u as z,B as S,b as R,c as d,R as G}from"./react-6dba30b1.js";import{S as y,_ as N}from"./syntax-bbe942a4.js";import{m as c,A as g,R as L,r as W,a as E}from"./fancy-0969c99d.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))i(a);new MutationObserver(a=>{for(const n of a)if(n.type==="childList")for(const l of n.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&i(l)}).observe(document,{childList:!0,subtree:!0});function o(a){const n={};return a.integrity&&(n.integrity=a.integrity),a.referrerPolicy&&(n.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?n.credentials="include":a.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(a){if(a.ep)return;a.ep=!0;const n=o(a);fetch(a.href,n)}})();var j={exports:{}},f={};/**
 * @license React
 ...
 */var T=r,H=Symbol.for("react.element"),F=Symbol.for("react.fragment"),Z=Object.prototype.hasOwnProperty,Y=T.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,V={key:!0,ref:!0,__self:!0,__source:!0};function k(s,t,o){var i,a={},n=null,l=null;o!==void 0&&(n=""+o),t.key!==void 0&&(n=""+t.key),t.ref!==void 0&&(l=t.ref);for(i in t)Z.call(t,i)&&!V.hasOwnProperty(i)&&(a[i]=t[i]);if(s&&s.defaultProps)for(i in t=s.defaultProps,t)a[i]===void 0&&(a[i]=t[i]);return{$$typeof:H,type:s,key:n,ref:l,props:a,_owner:Y.current}}f.Fragment=F;f.jsx=k;f.jsxs=k;j.exports=f;var e=j.exports,x={},_=C;x.createRoot=_.createRoot,x.hydrateRoot=_.hydrateRoot;function U(){const s=[{route:"/projects",name:"Projects"},{route:"/diary",name:"Diary"},{route:"/notes",name:"Notes"},{route:"/command-lines",name:"Command Lines"},{route:"/blogs",name:"Blogs"}];return e.jsxs("main",{className:"my-20 flex flex-col gap-10 items-center px-8",children:[e.jsx("h6",{className:"text-2xl font-black",children:"Hi! I am Saad"}),e.jsx("p",{className:"text-2xl sm:text-4xl font-extralight text-center w-full md:w-2/3",children:"I am a Software Developer with love for Machine Learning and Data Science."}),e.jsx("div",{className:"flex flex-row flex-wrap justify-center gap-2",children:s.map(t=>e.jsx(B,{to:t.route,className:"shadow-xl border border-opacity-25 border-lite font-serif bg-darklite text-2xl px-6 py-4 hover:bg-lite hover:text-darklite duration-300 transition-colors",children:t.name},t.route))})]})}const A=""+new URL("../technologies/JavaScript.png",import.meta.url).href,J=""+new URL("../technologies/Python.png",import.meta.url).href,M=""+new URL("../technologies/Html.png",import.meta.url).href,X=""+new URL("../technologies/Cpp.png",import.meta.url).href,O=""+new URL("../technologies/Ruby.png",import.meta.url).href,P=""+new URL("../technologies/Css.png",import.meta.url).href;function D(){return e.jsxs("section",{className:"px-8 bg-darklite min-w-full py-14 flex gap-10 lg:justify-center overflow-x-auto no-scrollbar",children:[e.jsx("img",{src:A}),e.jsx("img",{src:J}),e.jsx("img",{src:X}),e.jsx("img",{src:O}),e.jsx("img",{src:M}),e.jsx("img",{src:P})]})}function K({heading:s,leadingIcon:t,description:o,techStacks:i}){return e.jsxs("li",{className:"bg-darklite border-b-4 border-b-black border-opacity-40 p-8 flex flex-col gap-8 justify-between",children:[e.jsxs("div",{className:"flex flex-col items-center gap-6 w-48",children:[e.jsx("h5",{className:"text-4xl font-serif",children:s}),e.jsx("img",{src:t}),e.jsx("p",{className:"text-center",children:o})]}),e.jsx("ul",{className:"flex justify-center gap-3",children:i.map(a=>e.jsx("img",{src:a},a))})]})}const q=""+new URL("../technologies/Frontend.png",import.meta.url).href,Q=""+new URL("../technologies/Backend.png",import.meta.url).href,$=""+new URL("../technologies/ML.png",import.meta.url).href,ee=""+new URL("../technologies/Miscellaneous.png",import.meta.url).href,te=""+new URL("../technologies/React.png",import.meta.url).href,se=""+new URL("../technologies/Vite.png",import.meta.url).href,ne=""+new URL("../technologies/Tailwind.png",import.meta.url).href,ae=""+new URL("../technologies/Hotwired.png",import.meta.url).href,oe=""+new URL("../technologies/NodeJS.png",import.meta.url).href,ie=""+new URL("../technologies/PostgreSQL.png",import.meta.url).href,le=""+new URL("../technologies/MongoDB.png",import.meta.url).href,re=""+new URL("../technologies/RubyOnRails.png",import.meta.url).href,ce=""+new URL("../technologies/TensorFlow.png",import.meta.url).href,de=""+new URL("../technologies/PyTorch.png",import.meta.url).href,he=""+new URL("../technologies/Pandas.png",import.meta.url).href,pe=""+new URL("../technologies/Figma.png",import.meta.url).href,ue=""+new URL("../technologies/Rust.png",import.meta.url).href,me=""+new URL("../technologies/Unity.png",import.meta.url).href,ge=""+new URL("../technologies/BeautifulSoup4.png",import.meta.url).href;function fe(){const s=[{heading:"Frontend",leadingIcon:q,description:"Experienced with many frontend technologies, ranging from CSS frameworks to JavaScript ones.",techStacks:[te,se,ne,ae]},{heading:"Backend",leadingIcon:Q,description:"Have worked with different databases with different backend frameworks.",techStacks:[oe,ie,le,re]},{heading:"ML",leadingIcon:$,description:"Delved in the areas of machine learning and worked with related frameworks. Created NNs, Classifiers, GANs, Autoencoders etc.",techStacks:[ce,de,he]},{heading:"Miscellaneous",leadingIcon:ee,description:"Web Scraping as a hobby. Always enjoy and eager to learn new frameworks and programming languages.",techStacks:[pe,ue,me,ge]}];return e.jsxs(e.Fragment,{children:[e.jsx("h6",{className:"mt-20 text-2xl font-black text-center w-full md:w-2/3 px-4",children:"Versatile skill set in different domains, and always interested in expanding it even more."}),e.jsx("section",{className:"px-8 mb-20 mt-16 w-full flex justify-start lg:justify-center gap-8 overflow-x-auto no-scrollbar",children:s.map(({heading:t,leadingIcon:o,description:i,techStacks:a})=>e.jsx(K,{heading:t,leadingIcon:o,description:i,techStacks:a},t))})]})}function b(){return e.jsxs("header",{className:"mt-4 sm:mt-10 w-full lg:w-3/4 flex justify-between font-serif items-end border-b border-b-lite pb-3 sm:pb-6 px-3",children:[e.jsx("h1",{className:"text-xl sm:text-2xl lg:text-4xl",children:"Muhammad Saad Azam"}),e.jsxs("nav",{className:"hidden sm:flex gap-6 lg:gap-10 text-xl lg:text-2xl",children:[e.jsx("a",{href:"https://www.linkedin.com/in/saad-azam-9113011b8/",children:"LinkedIn"}),e.jsx("a",{href:"https://github.com/SadMadLad",children:"GitHub"}),e.jsx("a",{href:"https://www.kaggle.com/sadmadlad",children:"Kaggle"})]})]})}function be(){return e.jsxs("div",{className:"flex flex-col items-center",children:[e.jsx(b,{}),e.jsx(U,{}),e.jsx(D,{}),e.jsx(fe,{})]})}const I={"hljs-comment":{color:"#B6B18B"},"hljs-quote":{color:"#B6B18B"},"hljs-variable":{color:"#EB3C54"},"hljs-template-variable":{color:"#EB3C54"},"hljs-tag":{color:"#EB3C54"},"hljs-name":{color:"#EB3C54"},"hljs-selector-id":{color:"#EB3C54"},"hljs-selector-class":{color:"#EB3C54"},"hljs-regexp":{color:"#EB3C54"},"hljs-deletion":{color:"#EB3C54"},"hljs-number":{color:"#E7CE56"},"hljs-built_in":{color:"#E7CE56"},"hljs-builtin-name":{color:"#E7CE56"},"hljs-literal":{color:"#E7CE56"},"hljs-type":{color:"#E7CE56"},"hljs-params":{color:"#E7CE56"},"hljs-meta":{color:"#E7CE56"},"hljs-link":{color:"#E7CE56"},"hljs-attribute":{color:"#EE7C2B"},"hljs-string":{color:"#4FB4D7"},"hljs-symbol":{color:"#4FB4D7"},"hljs-bullet":{color:"#4FB4D7"},"hljs-addition":{color:"#4FB4D7"},"hljs-title":{color:"#78BB65"},"hljs-section":{color:"#78BB65"},"hljs-keyword":{color:"#B45EA4"},"hljs-selector-tag":{color:"#B45EA4"},hljs:{display:"block",overflowX:"auto",background:"#1C1D21",color:"#c0c5ce",padding:"0.5em"},"hljs-emphasis":{fontStyle:"italic"},"hljs-strong":{fontWeight:"bold"}},we={hljs:{display:"block",overflowX:"auto",padding:"0.5em",color:"#abb2bf",background:"#282c34"},"hljs-keyword":{color:"#F92672"},"hljs-operator":{color:"#F92672"},"hljs-pattern-match":{color:"#F92672"},"hljs-pattern-match .hljs-constructor":{color:"#61aeee"},"hljs-function":{color:"#61aeee"},"hljs-function .hljs-params":{color:"#A6E22E"},"hljs-function .hljs-params .hljs-typing":{color:"#FD971F"},"hljs-module-access .hljs-module":{color:"#7e57c2"},"hljs-constructor":{color:"#e2b93d"},"hljs-constructor .hljs-string":{color:"#9CCC65"},"hljs-comment":{color:"#b18eb1",fontStyle:"italic"},"hljs-quote":{color:"#b18eb1",fontStyle:"italic"},"hljs-doctag":{color:"#c678dd"},"hljs-formula":{color:"#c678dd"},"hljs-section":{color:"#e06c75"},"hljs-name":{color:"#e06c75"},"hljs-selector-tag":{color:"#e06c75"},"hljs-deletion":{color:"#e06c75"},"hljs-subst":{color:"#e06c75"},"hljs-literal":{color:"#56b6c2"},"hljs-string":{color:"#98c379"},"hljs-regexp":{color:"#98c379"},"hljs-addition":{color:"#98c379"},"hljs-attribute":{color:"#98c379"},"hljs-meta-string":{color:"#98c379"},"hljs-built_in":{color:"#e6c07b"},"hljs-class .hljs-title":{color:"#e6c07b"},"hljs-attr":{color:"#d19a66"},"hljs-variable":{color:"#d19a66"},"hljs-template-variable":{color:"#d19a66"},"hljs-type":{color:"#d19a66"},"hljs-selector-class":{color:"#d19a66"},"hljs-selector-attr":{color:"#d19a66"},"hljs-selector-pseudo":{color:"#d19a66"},"hljs-number":{color:"#d19a66"},"hljs-symbol":{color:"#61aeee"},"hljs-bullet":{color:"#61aeee"},"hljs-link":{color:"#61aeee",textDecoration:"underline"},"hljs-meta":{color:"#61aeee"},"hljs-selector-id":{color:"#61aeee"},"hljs-title":{color:"#61aeee"},"hljs-emphasis":{fontStyle:"italic"},"hljs-strong":{fontWeight:"bold"}};function xe({codeSnippet:s}){return e.jsx("div",{className:"my-2.5",children:e.jsx(y,{wrapLines:!0,style:I,language:s.language,children:s.code})})}function p({paragraph:s}){const{has_code_snippet:t,text:o,code_snippet:i}=s;return e.jsxs("div",{children:[e.jsx("p",{dangerouslySetInnerHTML:{__html:o}}),t&&e.jsx(xe,{codeSnippet:i})]})}function ye({solution:s}){const{has_intro:t,has_outro:o,steps:i}=s;return e.jsxs("div",{children:[t&&e.jsx(p,{paragraph:s.intro}),e.jsx("ul",{className:"list-decimal m-2",children:i.map((a,n)=>e.jsx("li",{children:e.jsx(p,{paragraph:a})},n))}),o&&e.jsx(p,{paragraph:s.outro})]})}function ve({title:s,titleId:t,...o},i){return r.createElement("svg",Object.assign({xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 20 20",fill:"currentColor","aria-hidden":"true",ref:i,"aria-labelledby":t},o),s?r.createElement("title",{id:t},s):null,r.createElement("path",{fillRule:"evenodd",d:"M5.23 7.21a.75.75 0 011.06.02L10 11.168l3.71-3.938a.75.75 0 111.08 1.04l-4.25 4.5a.75.75 0 01-1.08 0l-4.25-4.5a.75.75 0 01.02-1.06z",clipRule:"evenodd"}))}const _e=r.forwardRef(ve),w=_e;function je({title:s,type:t,updatedOn:o,description:i,solution:a}){const[n,l]=r.useState(!1),u=h=>{const m={Bug:"bg-red-600",Feature:"bg-green-600","Small Issue":"bg-yellow-600"};return e.jsx("button",{className:`${m[h]} px-1.5 py-0.5 rounded font-semibold`,children:h})};return e.jsxs(c.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},className:"px-2",children:[e.jsxs("div",{className:"flex flex-row gap-2 items-center border-b border-b-lite",children:[e.jsx("h5",{className:"font-bold text-lg",children:s}),e.jsx(c.div,{animate:{rotate:n?180:0,cursor:"pointer"},onClick:()=>l(!n),children:e.jsx(w,{className:"w-6 h-6"})})]}),e.jsx(g,{children:n&&e.jsxs(c.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},className:"flex flex-col gap-2.5 py-2",children:[e.jsxs("div",{className:"flex flex-col gap-0.5",children:[e.jsx("span",{children:u(t)}),e.jsxs("span",{children:[e.jsx("b",{children:"Updated On: "}),e.jsx("span",{children:o})]})]}),e.jsxs("div",{children:[e.jsx("h6",{className:"font-semibold",children:"Description:"}),e.jsx("p",{dangerouslySetInnerHTML:{__html:i}})]}),e.jsxs("div",{children:[e.jsx("h6",{className:"font-semibold",children:"Solution: "}),a.has_steps?e.jsx(ye,{solution:a}):e.jsx(p,{paragraph:a})]})]})})]})}function ke({title:s,entries:t}){const o=t.sort((n,l)=>n.title>l.title),[i,a]=r.useState(!1);return e.jsxs("section",{className:"mt-2.5 px-2 md:px-0",children:[e.jsxs("div",{className:"flex flex-row gap-2 items-center border-b-2 border-b-lite",children:[e.jsx("h4",{className:"font-serif font-bold text-2xl",children:s}),e.jsx(c.div,{animate:{rotate:i?180:0,cursor:"pointer"},onClick:()=>a(!i),children:e.jsx(w,{className:"w-8 h-8"})})]}),e.jsx(g,{children:i&&o.map((n,l)=>e.jsx(je,{title:n.title,type:n.type,updatedOn:n.updated_on,description:n.description,solution:n.solution},l))})]})}const Ie=[{title:"Ruby on Rails",entries:[{title:"Complex Validation for Password in Devise",type:"Bug",updated_on:"28th June, 2023",description:'I had to apply complex validation (like presence of a special character and a number) for password. I initially did it like this <code class="bg-zinc-800">validates :password, ..validations</code>. And on the app, I also had to update other info (like name) for the user. With this implementation, the password was coming out to be <code class="bg-zinc-800">nil</code>. At first, I thought that updating user required password, but that was not the case.',solution:{has_steps:!1,has_code_snippet:!0,text:`In a typical devise model (which in my case was <code class="bg-zinc-800">User</code>), there is no field/attribute named password. Instead, the encrypted password is stored in the database. So, how does Devise takes the input password? Actually, it stores the input password temporarily as <b>instance variable</b>, and I was unable to apply validations on the password field because on update, there was no instance variable of password being passed. This snippet basically checks if the instance of password variable is present, and allows it to be blank if the user is being updated. Otherwise, it checks for the specified regex expression. When it comes to creating new user, the presence of password can be checked by the length which is specified in devise's initializer file. The keypoint is understanding how devise manages passwords.`,code_snippet:{language:"ruby",code:`validate :password_regex
...
`}}}]}];function v({title:s,heroCaption:t}){return e.jsxs("section",{className:"flex flex-col gap-4 items-center my-20",children:[e.jsx("h1",{className:"font-black font-serif text-4xl",children:s}),e.jsx("p",{className:"text-xl text-center font-light w-full md:w-2/3",children:t})]})}function Ce(){const s=Ie.sort((t,o)=>t.title>o.title);return e.jsxs("div",{className:"flex flex-col items-center pb-6",children:[e.jsx(b,{}),e.jsx(v,{title:"Diary",heroCaption:"This diary includes some errors and bugs I encountered and how I fixed them, along with some code snippets."}),e.jsx("div",{className:"w-full md:w-3/4",children:s.map((t,o)=>e.jsx(ke,{title:t.title,entries:t.entries},o))})]})}const Be=[{command:"cat <path/to/filename>",description:"Open file in terminal."},{command:"sudo fuser -k <port>/<protocol>",description:'Kill a web process running on the specific port. Where port is the <code class="bg-zinc-800">port</code> on which the process is running, and the <code class="bg-zinc-800">protocol</code> is mostly <code class="bg-zinc-800">tcp</code> or <code class="bg-zinc-800">udp</code>.'},{command:"cargo new <project-name> --vcs=git",description:"Creates a new rust project with the given name. The --vcs flag allows to use Version Control System optionally."},{command:"chmod +x <file-name>",description:'<code class="bg-zinc-800">chmod</code> is short for Change Mode. It allows us to change the access of file permissions and directiories. The <code class="bg-zinc-800">+x</code> flag allows that file to be executable.'},{command:"man <command-name>",description:"Displays a manual related to the command in terminal."},{command:"script <file-name>",description:'Starts a script in terminal. Now whatever is written on the terminal, will be saved in the <code class="bg-zinc-800">file-name</code> after the <code class="bg-zinc-800">exit</code> command.'},{command:"mix new <project-name>",description:"Initializes a new mix project with the given project name."},{command:"mix deps.get",description:"Gets all out of date dependencies, i.e. dependencies that are not available or have an invalid lock."},{command:"mix compile",description:"The main entry point for the project. It runs the compilers in the project and returns a tuple with the compilation status and a list of diagnostics. Before compiling the code, it runs all the dependencies and performs a series of checks."},{command:"cargo build",description:'Builds the project, creates an executable file under <code class="bg-zinc-800">./target/debug/project-name</code>. Also, creates a <code span="bg-zinc-800">Cargo.toml</code> file to keep track of dependencies.'},{command:"cargo run",description:"Builds and executes the code in one go."},{command:"cargo check",description:"Does not execute the code but makes sure that the code compiles."},{command:"cargo build --release",description:"Compiles and optimizes the code and prepares to release the product."}];function ze(){const s=Be.sort((t,o)=>t.command>o.command);return e.jsx("main",{className:"px-5",children:e.jsx("ul",{className:"list-disc flex flex-col gap-4",children:s.map((t,o)=>e.jsxs("li",{children:[e.jsx(y,{wrapLines:!0,style:we,language:"vim",children:t.command}),e.jsx("p",{className:"mt-1",dangerouslySetInnerHTML:{__html:t.description}})]},o))})})}function Se(){return e.jsxs("div",{className:"flex flex-col items-center pb-6",children:[e.jsx(b,{}),e.jsx(v,{title:"Command Lines",heroCaption:"Some useful command lines that I learnt on the way"}),e.jsx("div",{className:"w-full md:w-3/4",children:e.jsx(ze,{})})]})}function Re({title:s,paragraphs:t}){const[o,i]=r.useState(!1);return e.jsxs(c.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},className:"px-2",children:[e.jsxs("div",{className:"flex flex-row gap-2 items-center border-b border-b-lite",children:[e.jsx("h5",{className:"font-bold text-lg",children:s}),e.jsx(c.div,{animate:{rotate:o?180:0,cursor:"pointer"},onClick:()=>i(!o),children:e.jsx(w,{className:"w-6 h-6"})})]}),e.jsx(g,{children:o&&e.jsx(c.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},className:"flex flex-col gap-2.5 py-2",children:t.map((a,n)=>e.jsx(p,{paragraph:a},n))})})]})}function Ge({title:s,notes:t}){const o=t.sort((n,l)=>n.title>l.title),[i,a]=r.useState(!1);return e.jsxs("section",{className:"px-2 md:px-0",children:[e.jsxs("div",{className:"flex flex-row gap-2 items-center border-b-2 border-b-lite",children:[e.jsx("h4",{className:"font-serif font-bold text-2xl",children:s}),e.jsx(c.div,{animate:{rotate:i?180:0,cursor:"pointer"},onClick:()=>a(!i),children:e.jsx(w,{className:"w-8 h-8"})})]}),e.jsx(g,{children:i&&o.map((n,l)=>e.jsx(Re,{title:n.title,paragraphs:n.paragraphs},l))})]})}const Ne=[{title:"C++",notes:[{title:"Preprocessors",paragraphs:[{text:"Preprocessors in a C++ file are basically commands or files executed before the file does. They start with a #.",has_code_snippet:!1}]},{title:"Header Guards",paragraphs:[{text:"Header Guards ensure us to include our file only once in our file and avoid redeclaration.",has_code_snippet:!1},{text:`There are two ways to define header guards. One is by using <code class="bg-zinc-800"><b>#pragma once</b></code> and the other is <code class="bg-zinc-800"><b>#ifndef, #define, #endif</b></code>. Both of these do the same thing and make sure to include the file only once.
...
`,has_code_snippet:!1}]}]}];function Le(){const s=Ne.sort((t,o)=>t.title>o.title);return e.jsxs("div",{className:"flex flex-col items-center pb-6",children:[e.jsx(b,{}),e.jsx(v,{title:"Notes",heroCaption:"This page has some notes, tips and some resources that I learnt about on my way."}),e.jsx("div",{className:"w-full md:w-3/4 flex flex-col gap-2.5",children:s.map((t,o)=>e.jsx(Ge,{title:t.title,notes:t.notes},o))})]})}function We(){return e.jsx("div",{children:"Coming Soon."})}function Ee(){return e.jsx("article",{children:"Coming soon."})}const Te=[{identifier:"hello-world",tags:["JavaScript","Ruby","Markdown"],category:"Other",date:"3rd August, 2023"}],He=s=>Te.find(({identifier:t})=>t==s),Fe="data:text/markdown;base64,";function Ze(){const{identifier:s}=z(),[t,o]=r.useState("");return He(s)===void 0?e.jsx("div",{children:"Not Found"}):(N(()=>import(Fe),[],import.meta.url).then(a=>{fetch(a.default).then(n=>n.text()).then(n=>o(n))}),e.jsx("article",{className:"markdown",children:e.jsx(L,{rehypePlugins:[W],remarkPlugins:[E],children:t,components:{code({node:a,inline:n,className:l,children:u,...h}){const m=/language-(\w+)/.exec(l||"");return!n&&m?e.jsx(y,{...h,children:String(u).replace(/\n$/,""),style:I,language:m[1]}):e.jsx("code",{...h,className:l,children:u})}}})}))}function Ye(){return e.jsx(S,{children:e.jsxs(R,{children:[e.jsx(d,{path:"/",element:e.jsx(be,{})}),e.jsx(d,{exact:!0,path:"/diary",element:e.jsx(Ce,{})}),e.jsx(d,{exact:!0,path:"/command-lines",element:e.jsx(Se,{})}),e.jsx(d,{exact:!0,path:"/notes",element:e.jsx(Le,{})}),e.jsx(d,{exact:!0,path:"/projects",element:e.jsx(We,{})}),e.jsx(d,{exact:!0,path:"/blogs",element:e.jsx(Ee,{})}),e.jsx(d,{path:"/blog/:identifier",element:e.jsx(Ze,{})})]})})}x.createRoot(document.getElementById("root")).render(e.jsx(G.StrictMode,{children:e.jsx(Ye,{})}));
