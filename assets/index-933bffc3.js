import{r as c,a as B,L as C,u as R,b as P,c as A,d as h,B as L,R as O}from"./react-312bfbfe.js";import{u as M,m as l,A as m,a as D,b as F,R as U,r as H,c as q}from"./fancy-ca7fad63.js";import{S as k,_ as $}from"./syntax-2fc24623.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const o of n)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function a(n){const o={};return n.integrity&&(o.integrity=n.integrity),n.referrerPolicy&&(o.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?o.credentials="include":n.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(n){if(n.ep)return;n.ep=!0;const o=a(n);fetch(n.href,o)}})();var I={exports:{}},f={};/**
 * @license React
 ...
 */var W=c,V=Symbol.for("react.element"),J=Symbol.for("react.fragment"),G=Object.prototype.hasOwnProperty,X=W.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,Y={key:!0,ref:!0,__self:!0,__source:!0};function N(s,t,a){var i,n={},o=null,r=null;a!==void 0&&(o=""+a),t.key!==void 0&&(o=""+t.key),t.ref!==void 0&&(r=t.ref);for(i in t)G.call(t,i)&&!Y.hasOwnProperty(i)&&(n[i]=t[i]);if(s&&s.defaultProps)for(i in t=s.defaultProps,t)n[i]===void 0&&(n[i]=t[i]);return{$$typeof:V,type:s,key:o,ref:r,props:n,_owner:X.current}}f.Fragment=J;f.jsx=N;f.jsxs=N;I.exports=f;var e=I.exports,_={},T=B;_.createRoot=T.createRoot,_.hydrateRoot=T.hydrateRoot;function K(){const s=[{route:"/projects",name:"Projects"},{route:"/diary",name:"Diary"},{route:"/notes",name:"Notes"},{route:"/command-lines",name:"Command Lines"},{route:"/blogs",name:"Blogs"}];return e.jsxs("main",{className:"my-20 flex flex-col gap-10 items-center px-8",children:[e.jsx("h6",{className:"text-2xl font-black",children:"Hi! I am Saad"}),e.jsx("p",{className:"text-2xl sm:text-4xl font-extralight text-center w-full md:w-2/3",children:"I am a Software Developer with love for Machine Learning and Data Science."}),e.jsx("div",{className:"flex flex-row flex-wrap justify-center gap-2",children:s.map(t=>e.jsx(C,{to:t.route,className:"shadow-xl border border-opacity-25 border-lite font-serif bg-darklite text-2xl px-6 py-4 hover:bg-lite hover:text-darklite duration-300 transition-colors",children:t.name},t.route))})]})}const Q="/sadmadlad/technologies/JavaScript.png",Z="/sadmadlad/technologies/Python.png",ee="/sadmadlad/technologies/Html.png",te="/sadmadlad/technologies/Cpp.png",se="/sadmadlad/technologies/Ruby.png",ae="/sadmadlad/technologies/Css.png";function ne(){return e.jsxs("section",{className:"px-8 bg-darklite min-w-full py-14 flex gap-10 lg:justify-center overflow-x-auto no-scrollbar",children:[e.jsx("img",{src:Q}),e.jsx("img",{src:Z}),e.jsx("img",{src:te}),e.jsx("img",{src:se}),e.jsx("img",{src:ee}),e.jsx("img",{src:ae})]})}function oe({heading:s,leadingIcon:t,description:a,techStacks:i}){return e.jsxs("li",{className:"bg-darklite border-b-4 border-b-black border-opacity-40 p-8 flex flex-col gap-8 justify-between",children:[e.jsxs("div",{className:"flex flex-col items-center gap-6 w-48",children:[e.jsx("h5",{className:"text-4xl font-serif",children:s}),e.jsx("img",{src:t}),e.jsx("p",{className:"text-center",children:a})]}),e.jsx("ul",{className:"flex justify-center gap-3",children:i.map(n=>e.jsx("img",{src:n},n))})]})}const ie="/sadmadlad/technologies/Frontend.png",re="/sadmadlad/technologies/Backend.png",ce="/sadmadlad/technologies/ML.png",le="/sadmadlad/technologies/Miscellaneous.png",de="/sadmadlad/technologies/React.png",he="/sadmadlad/technologies/Vite.png",pe="/sadmadlad/technologies/Tailwind.png",ue="/sadmadlad/technologies/Hotwired.png",me="/sadmadlad/technologies/NodeJS.png",ge="/sadmadlad/technologies/PostgreSQL.png",fe="/sadmadlad/technologies/MongoDB.png",be="/sadmadlad/technologies/RubyOnRails.png",xe="/sadmadlad/technologies/TensorFlow.png",we="/sadmadlad/technologies/PyTorch.png",ye="/sadmadlad/technologies/Pandas.png",_e="/sadmadlad/technologies/Figma.png",ve="/sadmadlad/technologies/Rust.png",ke="/sadmadlad/technologies/Unity.png",je="/sadmadlad/technologies/BeautifulSoup4.png";function ze(){const s=[{heading:"Frontend",leadingIcon:ie,description:"Experienced with many frontend technologies, ranging from CSS frameworks to JavaScript ones.",techStacks:[de,he,pe,ue]},{heading:"Backend",leadingIcon:re,description:"Have worked with different databases with different backend frameworks.",techStacks:[me,ge,fe,be]},{heading:"ML",leadingIcon:ce,description:"Delved in the areas of machine learning and worked with related frameworks. Created NNs, Classifiers, GANs, Autoencoders etc.",techStacks:[xe,we,ye]},{heading:"Miscellaneous",leadingIcon:le,description:"Web Scraping as a hobby. Always enjoy and eager to learn new frameworks and programming languages.",techStacks:[_e,ve,ke,je]}];return e.jsxs(e.Fragment,{children:[e.jsx("h6",{className:"mt-20 text-2xl font-black text-center w-full md:w-2/3 px-4",children:"Versatile skill set in different domains, and always interested in expanding it even more."}),e.jsx("section",{className:"px-8 mb-20 mt-16 w-full flex justify-start lg:justify-center gap-8 overflow-x-auto no-scrollbar",children:s.map(({heading:t,leadingIcon:a,description:i,techStacks:n})=>e.jsx(oe,{heading:t,leadingIcon:a,description:i,techStacks:n},t))})]})}function b(){return e.jsxs("header",{className:"mt-4 sm:mt-10 w-full lg:w-3/4 flex justify-between font-serif items-end border-b border-b-lite pb-3 sm:pb-6 px-3",children:[e.jsx("h1",{className:"text-xl sm:text-2xl lg:text-4xl",children:"Muhammad Saad Azam"}),e.jsxs("nav",{className:"hidden sm:flex gap-6 lg:gap-10 text-xl lg:text-2xl",children:[e.jsx("a",{href:"https://www.linkedin.com/in/saad-azam-9113011b8/",children:"LinkedIn"}),e.jsx("a",{href:"https://github.com/SadMadLad",children:"GitHub"}),e.jsx("a",{href:"https://www.kaggle.com/sadmadlad",children:"Kaggle"})]})]})}function x(){const s=M();return e.jsx(l.div,{className:"fixed w-full h-full top-0 bottom-0 right-0 bg-white",initial:{scaleX:1},animate:{scaleX:0,transition:{duration:.33,ease:"circOut"}},exit:{scaleX:1,transition:{duration:.33,ease:"circIn"}},style:{originX:s?0:1}})}function Se(){return e.jsxs("div",{className:"flex flex-col items-center",children:[e.jsx(b,{}),e.jsx(K,{}),e.jsx(ne,{}),e.jsx(ze,{}),e.jsx(x,{})]})}const E={"hljs-comment":{color:"#B6B18B"},"hljs-quote":{color:"#B6B18B"},"hljs-variable":{color:"#EB3C54"},"hljs-template-variable":{color:"#EB3C54"},"hljs-tag":{color:"#EB3C54"},"hljs-name":{color:"#EB3C54"},"hljs-selector-id":{color:"#EB3C54"},"hljs-selector-class":{color:"#EB3C54"},"hljs-regexp":{color:"#EB3C54"},"hljs-deletion":{color:"#EB3C54"},"hljs-number":{color:"#E7CE56"},"hljs-built_in":{color:"#E7CE56"},"hljs-builtin-name":{color:"#E7CE56"},"hljs-literal":{color:"#E7CE56"},"hljs-type":{color:"#E7CE56"},"hljs-params":{color:"#E7CE56"},"hljs-meta":{color:"#E7CE56"},"hljs-link":{color:"#E7CE56"},"hljs-attribute":{color:"#EE7C2B"},"hljs-string":{color:"#4FB4D7"},"hljs-symbol":{color:"#4FB4D7"},"hljs-bullet":{color:"#4FB4D7"},"hljs-addition":{color:"#4FB4D7"},"hljs-title":{color:"#78BB65"},"hljs-section":{color:"#78BB65"},"hljs-keyword":{color:"#B45EA4"},"hljs-selector-tag":{color:"#B45EA4"},hljs:{display:"block",overflowX:"auto",background:"#1C1D21",color:"#c0c5ce",padding:"0.5em"},"hljs-emphasis":{fontStyle:"italic"},"hljs-strong":{fontWeight:"bold"}},Te={hljs:{display:"block",overflowX:"auto",padding:"0.5em",color:"#abb2bf",background:"#282c34"},"hljs-keyword":{color:"#F92672"},"hljs-operator":{color:"#F92672"},"hljs-pattern-match":{color:"#F92672"},"hljs-pattern-match .hljs-constructor":{color:"#61aeee"},"hljs-function":{color:"#61aeee"},"hljs-function .hljs-params":{color:"#A6E22E"},"hljs-function .hljs-params .hljs-typing":{color:"#FD971F"},"hljs-module-access .hljs-module":{color:"#7e57c2"},"hljs-constructor":{color:"#e2b93d"},"hljs-constructor .hljs-string":{color:"#9CCC65"},"hljs-comment":{color:"#b18eb1",fontStyle:"italic"},"hljs-quote":{color:"#b18eb1",fontStyle:"italic"},"hljs-doctag":{color:"#c678dd"},"hljs-formula":{color:"#c678dd"},"hljs-section":{color:"#e06c75"},"hljs-name":{color:"#e06c75"},"hljs-selector-tag":{color:"#e06c75"},"hljs-deletion":{color:"#e06c75"},"hljs-subst":{color:"#e06c75"},"hljs-literal":{color:"#56b6c2"},"hljs-string":{color:"#98c379"},"hljs-regexp":{color:"#98c379"},"hljs-addition":{color:"#98c379"},"hljs-attribute":{color:"#98c379"},"hljs-meta-string":{color:"#98c379"},"hljs-built_in":{color:"#e6c07b"},"hljs-class .hljs-title":{color:"#e6c07b"},"hljs-attr":{color:"#d19a66"},"hljs-variable":{color:"#d19a66"},"hljs-template-variable":{color:"#d19a66"},"hljs-type":{color:"#d19a66"},"hljs-selector-class":{color:"#d19a66"},"hljs-selector-attr":{color:"#d19a66"},"hljs-selector-pseudo":{color:"#d19a66"},"hljs-number":{color:"#d19a66"},"hljs-symbol":{color:"#61aeee"},"hljs-bullet":{color:"#61aeee"},"hljs-link":{color:"#61aeee",textDecoration:"underline"},"hljs-meta":{color:"#61aeee"},"hljs-selector-id":{color:"#61aeee"},"hljs-title":{color:"#61aeee"},"hljs-emphasis":{fontStyle:"italic"},"hljs-strong":{fontWeight:"bold"}};function Ce({codeSnippet:s}){return e.jsx("div",{className:"my-2.5",children:e.jsx(k,{wrapLines:!0,style:E,language:s.language,children:s.code})})}function u({paragraph:s}){const{has_code_snippet:t,text:a,code_snippet:i}=s;return e.jsxs("div",{children:[e.jsx("p",{dangerouslySetInnerHTML:{__html:a}}),t&&e.jsx(Ce,{codeSnippet:i})]})}function Ie({solution:s}){const{has_intro:t,has_outro:a,steps:i}=s;return e.jsxs("div",{children:[t&&e.jsx(u,{paragraph:s.intro}),e.jsx("ul",{className:"list-decimal m-2",children:i.map((n,o)=>e.jsx("li",{children:e.jsx(u,{paragraph:n})},o))}),a&&e.jsx(u,{paragraph:s.outro})]})}function Ne({title:s,titleId:t,...a},i){return c.createElement("svg",Object.assign({xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 20 20",fill:"currentColor","aria-hidden":"true",ref:i,"aria-labelledby":t},a),s?c.createElement("title",{id:t},s):null,c.createElement("path",{fillRule:"evenodd",d:"M5.23 7.21a.75.75 0 011.06.02L10 11.168l3.71-3.938a.75.75 0 111.08 1.04l-4.25 4.5a.75.75 0 01-1.08 0l-4.25-4.5a.75.75 0 01.02-1.06z",clipRule:"evenodd"}))}const Ee=c.forwardRef(Ne),w=Ee;function Be({title:s,type:t,updatedOn:a,description:i,solution:n}){const[o,r]=c.useState(!1),y=p=>{const d={Bug:"bg-red-600",Feature:"bg-green-600","Small Issue":"bg-yellow-600"};return e.jsx("button",{className:`${d[p]} px-1.5 py-0.5 rounded font-semibold`,children:p})};return e.jsxs(l.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},className:"px-2",children:[e.jsxs("div",{className:"flex flex-row gap-2 items-center border-b border-b-lite",children:[e.jsx("h5",{className:"font-bold text-lg",children:s}),e.jsx(l.div,{animate:{rotate:o?180:0,cursor:"pointer"},onClick:()=>r(!o),children:e.jsx(w,{className:"w-6 h-6"})})]}),e.jsx(m,{children:o&&e.jsxs(l.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},className:"flex flex-col gap-2.5 py-2",children:[e.jsxs("div",{className:"flex flex-col gap-0.5",children:[e.jsx("span",{children:y(t)}),e.jsxs("span",{children:[e.jsx("b",{children:"Updated On: "}),e.jsx("span",{children:a})]})]}),e.jsxs("div",{children:[e.jsx("h6",{className:"font-semibold",children:"Description:"}),e.jsx("p",{dangerouslySetInnerHTML:{__html:i}})]}),e.jsxs("div",{children:[e.jsx("h6",{className:"font-semibold",children:"Solution: "}),n.has_steps?e.jsx(Ie,{solution:n}):e.jsx(u,{paragraph:n})]})]})})]})}function Re({title:s,entries:t}){const a=t.sort((o,r)=>o.title>r.title),[i,n]=c.useState(!1);return e.jsxs("section",{className:"mt-2.5 px-2 md:px-0",children:[e.jsxs("div",{className:"flex flex-row gap-2 items-center border-b-2 border-b-lite",children:[e.jsx("h4",{className:"font-serif font-bold text-2xl",children:s}),e.jsx(l.div,{animate:{rotate:i?180:0,cursor:"pointer"},onClick:()=>n(!i),children:e.jsx(w,{className:"w-8 h-8"})})]}),e.jsx(m,{children:i&&a.map((o,r)=>e.jsx(Be,{title:o.title,type:o.type,updatedOn:o.updated_on,description:o.description,solution:o.solution},r))})]})}const Pe=[{title:"React",entries:[{title:"Animated Page Transitions",type:"Feature",updated_on:"4th August, 2023.",description:'Wanted to have cook framer motion page transitions from one to the other. Like <a class="underline" href="https://codesandbox.io/s/framer-motion-screen-wipe-page-transitions-with-react-router-6-yo38bu?from-embed=&file=/src/template/Gallery.tsx:1296-1334">this</a>',solution:{has_steps:!0,has_intro:!0,has_outro:!1,intro:{has_code_snippet:!1,text:'The page transitions using framer motion requires use of <code class="bg-zinc-800">useLocation</code>, <code class="bg-zinc-800">AnimatePresence</code>, <code class="bg-zinc-800">useIsPresent</code> along with the <code class="bg-zinc-800">react-router-dom</code>'},steps:[{text:`Create a component which wraps all the <code class="bg-zinc-800">Routes</code> (and the <code class="bg-zinc-800">Switch</code> or <code class="bg-zinc-800">Router</code> alongwith.)
...
`}}}]}];function j({title:s,heroCaption:t}){return e.jsxs("section",{className:"flex flex-col gap-4 items-center my-20",children:[e.jsx("h1",{className:"font-black font-serif text-4xl",children:s}),e.jsx("p",{className:"text-xl text-center font-light w-full md:w-2/3",children:t})]})}function Ae(){const s=Pe.sort((t,a)=>t.title>a.title);return e.jsxs("div",{className:"flex flex-col items-center pb-6",children:[e.jsx(b,{}),e.jsx(j,{title:"Diary",heroCaption:"This diary includes some errors and bugs I encountered and how I fixed them, along with some code snippets."}),e.jsx("div",{className:"w-full md:w-3/4",children:s.map((t,a)=>e.jsx(Re,{title:t.title,entries:t.entries},a))}),e.jsx(x,{})]})}const Le=[{command:"cat <path/to/filename>",description:"Open file in terminal."},{command:"sudo fuser -k <port>/<protocol>",description:'Kill a web process running on the specific port. Where port is the <code class="bg-zinc-800">port</code> on which the process is running, and the <code class="bg-zinc-800">protocol</code> is mostly <code class="bg-zinc-800">tcp</code> or <code class="bg-zinc-800">udp</code>.'},{command:"cargo new <project-name> --vcs=git",description:"Creates a new rust project with the given name. The --vcs flag allows to use Version Control System optionally."},{command:"chmod +x <file-name>",description:'<code class="bg-zinc-800">chmod</code> is short for Change Mode. It allows us to change the access of file permissions and directiories. The <code class="bg-zinc-800">+x</code> flag allows that file to be executable.'},{command:"man <command-name>",description:"Displays a manual related to the command in terminal."},{command:"script <file-name>",description:'Starts a script in terminal. Now whatever is written on the terminal, will be saved in the <code class="bg-zinc-800">file-name</code> after the <code class="bg-zinc-800">exit</code> command.'},{command:"git remote add <name> <link>",description:"Add a remote link to the repo. Can be github, bitbucket, heroku etc."},{command:"git push -u <remote-branch-name> <local-branch-name>",description:"Push a local branch to remote one. The -u flag is used to set the upstream branch for the current branch you are pushing."},{command:"mix new <project-name>",description:"Initializes a new mix project with the given project name."},{command:"mix deps.get",description:"Gets all out of date dependencies, i.e. dependencies that are not available or have an invalid lock."},{command:"mix compile",description:"The main entry point for the project. It runs the compilers in the project and returns a tuple with the compilation status and a list of diagnostics. Before compiling the code, it runs all the dependencies and performs a series of checks."},{command:"npm create vite@latest project-name -- --template <react | vue | svelte>",description:"Initialize a project using vite with the provided template."},{command:"npm install -D package-name",description:"Install a package as dev dependency."},{command:"cargo build",description:'Builds the project, creates an executable file under <code class="bg-zinc-800">./target/debug/project-name</code>. Also, creates a <code span="bg-zinc-800">Cargo.toml</code> file to keep track of dependencies.'},{command:"cargo run",description:"Builds and executes the code in one go."},{command:"cargo check",description:"Does not execute the code but makes sure that the code compiles."},{command:"cargo build --release",description:"Compiles and optimizes the code and prepares to release the product."}];function Oe(){const s=Le.sort((t,a)=>t.command>a.command);return e.jsx("main",{className:"px-5",children:e.jsx("ul",{className:"list-disc flex flex-col gap-4",children:s.map((t,a)=>e.jsxs("li",{children:[e.jsx(k,{wrapLines:!0,style:Te,language:"vim",children:t.command}),e.jsx("p",{className:"mt-1",dangerouslySetInnerHTML:{__html:t.description}})]},a))})})}function Me(){return e.jsxs("div",{className:"flex flex-col items-center pb-6",children:[e.jsx(b,{}),e.jsx(j,{title:"Command Lines",heroCaption:"Some useful command lines that I learnt on the way"}),e.jsx("div",{className:"w-full md:w-3/4",children:e.jsx(Oe,{})}),e.jsx(x,{})]})}function De({title:s,paragraphs:t}){const[a,i]=c.useState(!1);return e.jsxs(l.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},className:"px-2",children:[e.jsxs("div",{className:"flex flex-row gap-2 items-center border-b border-b-lite",children:[e.jsx("h5",{className:"font-bold text-lg",children:s}),e.jsx(l.div,{animate:{rotate:a?180:0,cursor:"pointer"},onClick:()=>i(!a),children:e.jsx(w,{className:"w-6 h-6"})})]}),e.jsx(m,{children:a&&e.jsx(l.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},className:"flex flex-col gap-2.5 py-2",children:t.map((n,o)=>e.jsx(u,{paragraph:n},o))})})]})}function Fe({title:s,notes:t}){const a=t.sort((o,r)=>o.title>r.title),[i,n]=c.useState(!1);return e.jsxs("section",{className:"px-2 md:px-0",children:[e.jsxs("div",{className:"flex flex-row gap-2 items-center border-b-2 border-b-lite",children:[e.jsx("h4",{className:"font-serif font-bold text-2xl",children:s}),e.jsx(l.div,{animate:{rotate:i?180:0,cursor:"pointer"},onClick:()=>n(!i),children:e.jsx(w,{className:"w-8 h-8"})})]}),e.jsx(m,{children:i&&a.map((o,r)=>e.jsx(De,{title:o.title,paragraphs:o.paragraphs},r))})]})}const Ue=[{title:"C++",notes:[{title:"Preprocessors",paragraphs:[{text:"Preprocessors in a C++ file are basically commands or files executed before the file does. They start with a #.",has_code_snippet:!1}]},{title:"Header Guards",paragraphs:[{text:"Header Guards ensure us to include our file only once in our file and avoid redeclaration.",has_code_snippet:!1},{text:`There are two ways to define header guards. One is by using <code class="bg-zinc-800"><b>#pragma once</b></code> and the other is <code class="bg-zinc-800"><b>#ifndef, #define, #endif</b></code>. Both of these do the same thing and make sure to include the file only once.
...
`,has_code_snippet:!1}]}]},{title:"Node",notes:[{title:"npm vs npx",paragraphs:[{text:'<code class="bg-zinc-800">npm</code> is used to install packages.',has_code_snippet:!1},{text:'<code class="bg-zinc-800">npx</code> is used to execute packages.',has_code_snippet:!1}]}]}];function He(){const s=Ue.sort((t,a)=>t.title>a.title);return e.jsxs("div",{className:"flex flex-col items-center pb-6",children:[e.jsx(b,{}),e.jsx(j,{title:"Notes",heroCaption:"This page has some notes, tips and some resources that I learnt about on my way."}),e.jsx("div",{className:"w-full md:w-3/4 flex flex-col gap-2.5",children:s.map((t,a)=>e.jsx(Fe,{title:t.title,notes:t.notes},a))}),e.jsx(x,{})]})}function qe(){return e.jsx("div",{children:"Coming Soon."})}const v=[{identifier:"os-william-stallings",tags:["Operating Systems","Book Review","Computer Science"],categories:["Operating Systems","Book Reviews"],title:"Book Review: Operating Systems by William Stallings",date:"23rd June, 2023.",cover:!1}];function $e(){return console.log(v),e.jsx("ul",{children:v.map(({identifier:s,date:t,title:a})=>e.jsx("li",{children:e.jsxs(C,{to:`/blog/${s}`,children:[a,", ",t]})},s))})}const We=async s=>v.find(({identifier:t})=>t===s),Ve=async s=>{const t=`/sadmadlad/src/assets/blogs/${s}.md`,a=await $(()=>import(t),[]);return await(await fetch(a.default)).text()},Je=async s=>await We(s)===void 0?{blogFound:!1,blog:void 0}:{blogFound:!0,blog:await Ve(s)};function Ge(){const{scrollYProgress:s}=D(),t=F(s,{stiffness:100,damping:30,restDelta:.001}),{identifier:a}=R(),[i,n]=c.useState(!1),[o,r]=c.useState("");return c.useEffect(()=>{(async p=>{const{blogFound:d,blog:g}=await Je(p);d&&r(g),n(d)})(a)},[a]),e.jsx(e.Fragment,{children:i?e.jsxs("article",{className:"markdown",children:[e.jsx(U,{rehypePlugins:[H],remarkPlugins:[q],children:o,components:{code({node:y,inline:p,className:d,children:g,...z}){const S=/language-(\w+)/.exec(d||"");return!p&&S?e.jsx(k,{...z,children:String(g).replace(/\n$/,""),style:E,language:S[1]}):e.jsx("code",{...z,className:d,children:g})}}}),e.jsx(l.div,{className:"bg-accent h-2 w-full fixed bottom-20 text-center",style:{scaleX:t}})]}):e.jsx("div",{children:"Not Found"})})}function Xe(){const s=P();return e.jsx(m,{mode:"wait",initial:!1,children:e.jsxs(A,{location:s,children:[e.jsx(h,{path:"/",element:e.jsx(Se,{})}),e.jsx(h,{path:"/diary",element:e.jsx(Ae,{})}),e.jsx(h,{path:"/command-lines",element:e.jsx(Me,{})}),e.jsx(h,{path:"/notes",element:e.jsx(He,{})}),e.jsx(h,{path:"/projects",element:e.jsx(qe,{})}),e.jsx(h,{path:"/blogs",element:e.jsx($e,{})}),e.jsx(h,{path:"/blog/:identifier",element:e.jsx(Ge,{})})]},s.pathname)})}function Ye(){return e.jsx(L,{basename:"/sadmadlad",children:e.jsx(Xe,{})})}_.createRoot(document.getElementById("root")).render(e.jsx(O.StrictMode,{children:e.jsx(Ye,{})}));
