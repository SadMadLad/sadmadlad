  ...
  return (
    <main className="my-20 flex flex-col gap-10 items-center px-8">
      ...
      <div className="flex flex-row flex-wrap justify-center gap-2">
        <Link to="/projects" className="shadow-xl border border-opacity-25 border-lite font-serif bg-darklite text-2xl px-6 py-4 hover:bg-lite hover:text-darklite duration-300 transition-colors">Projects</Link>
